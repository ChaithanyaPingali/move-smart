...
export const Quotations: React.FC = () => {
  ...
  const [viewQuotation, setViewQuotation] = useState<Quotation | null>()
  ...
  const columns: ColumnsType<Quotation> = [
    ...
    },
    {
      ...
      render: (_, quotationDetails) => (
        <Space size={'large'}>
          <Popover title='View Quotation'>
            <EllipsisOutlined
              onClick={() => {
                setViewQuotation(quotationDetails)
              }}
            />
          </Popover>
  ...
  const handleViewQuotation = (): void => {
  ...
  return (
    <>
      ...
      <ViewQuotation
        isModalOpen={!(viewQuotation == null)}
        handleCancel={handleViewQuotation}
